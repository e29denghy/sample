...
<head>
    ...
    <meta name="description" content="@yield('description', '记录 AI 教学产品、教学资源平台和 Laravel 项目的开发过程。')">
...
<body class="site-body">
    <header class="site-header">
        <div class="shell nav-shell">
            ...
            <nav aria-label="主导航" class="site-nav">
                ...
                <a href="{{ route('now') }}" @class(['is-active' => request()->routeIs('now')]) @if(request()->routeIs('now')) aria-current="page" @endif>近况</a>
                <a href="{{ route('about') }}" @class(['is-active' => request()->routeIs('about')]) @if(request()->routeIs('about')) aria-current="page" @endif>关于</a>
    ...
    <footer class="site-footer">
        <div class="shell footer-grid">
            <div class="footer-intro"><strong>程序员的个人修养</strong><p>邓红宇的开发笔记。写 AI 教学产品、Laravel，也写做项目时遇到的问题。</p></div>
