...
<head>
    ...
    <title>@yield('title', 'denghy / 工程现场')</title>
    <meta name="description" content="@yield('description', 'Production notes on AI, content systems and Laravel.')">
    <link rel="canonical" href="@yield('canonical', url()->current())">
    <link rel="alternate" type="application/rss+xml" title="denghy RSS" href="{{ route('feeds.rss') }}">
    <link rel="alternate" type="application/atom+xml" title="denghy Atom" href="{{ route('feeds.atom') }}">
    @stack('head')
...
<body class="site-body">
    <header class="site-header">
        <div class="shell nav-shell">
            <a class="brand" href="{{ route('home') }}">denghy <span>/ 工程现场</span></a>
    ...
    <footer class="site-footer">
        <div class="shell footer-grid">
            <p>把复杂的 AI、内容与业务流程，做成可验证、可发布、可维护的系统。</p>
